 ...
 * @param {number} radius
 */
export function blur_raw(ptr, width, height, radius) {
  wasm.blur_raw(ptr, width, height, radius);
}
 ...
 * @param {Uint8Array} data
 */
export function grayscale_in_place(data) {
  var ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
  var len0 = WASM_VECTOR_LEN;
  wasm.grayscale_in_place(ptr0, len0, data);
}
 ...
 * @param {number} len
 */
export function grayscale_raw(ptr, len) {
  wasm.grayscale_raw(ptr, len);
}
 ...
 * @param {number} len
 */
export function invert_raw(ptr, len) {
  wasm.invert_raw(ptr, len);
}
 ...
 * @param {number} len
 */
export function sepia_raw(ptr, len) {
  wasm.sepia_raw(ptr, len);
}
